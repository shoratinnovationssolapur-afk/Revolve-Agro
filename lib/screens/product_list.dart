                        ...
                        sliver: SliverList.builder(
                          ...
                          itemBuilder: (context, index) {
                            final anim = CurvedAnimation(
                              ...
                              curve: Interval((index / (products.length > 0 ? products.length : 1)).clamp(0, 1), 1.0, curve: Curves.easeOut),
                            );
...
class _ProductCreativeCardState extends State<_ProductCreativeCard> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetailsPage(product: widget.product))),
      child: AppGlassCard(
